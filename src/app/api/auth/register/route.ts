...
export async function POST(req: NextRequest) {
  ...
  if (existingUsername) return apiError('username_taken', 'Этот ник уже занят', 409)
  if (existingEmail) return apiError('email_taken', 'Эта почта уже зарегистрирована', 409)
