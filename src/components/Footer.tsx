            ...
            <div className="space-y-3">
              ...
              <a
                ...
                onMouseEnter={e => {
                  ...
                  ;(e.currentTarget as HTMLElement).style.backgroundColor = '#1a1a3a'
                }}
                onMouseLeave={e => {
              ...
              <a
                ...
                onMouseEnter={e => {
                  (e.currentTarget as HTMLElement).style.borderColor = '#4C75A3'
                  ;(e.currentTarget as HTMLElement).style.backgroundColor = '#0f1f3a'
                }}
                onMouseLeave={e => {
                  (e.currentTarget as HTMLElement).style.borderColor = '#1a3a5c'
                  ;(e.currentTarget as HTMLElement).style.backgroundColor = '#0f1f2e'
                }}
              >
