          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-lg border border-[#3a3a5c] bg-[#1a1a2e] hover:border-[#5865F2] hover:bg-[#1a1a3a] transition-all duration-200"
              ...
              >
                ...
                <div>
                  <div style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 11, fontWeight: 700, color: '#5865F2' }}>DISCORD</div>
                  <div style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 9, color: '#555', letterSpacing: '0.1em' }}>Чат · Ивенты · Поддержка</div>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-4 py-3 rounded-lg border border-[#1a3a5c] bg-[#0f1f2e] hover:border-[#4C75A3] hover:bg-[#0f1f3a] transition-all duration-200"
                style={{ textDecoration: 'none' }}
              >
                ...
                <div>
                  <div style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 11, fontWeight: 700, color: '#4C75A3' }}>ВКонтакте</div>
                  <div style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 9, color: '#555', letterSpacing: '0.1em' }}>Новости · Поддержка</div>
                </div>
              </a>
            </div>
          </div>
